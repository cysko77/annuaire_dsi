...
>()(
  { languages, fallbackLanguage },
  {
    "en": {
      ...
      "SoftwareForm": {
        "stepper title": ({ currentStepIndex, softwareName, action }) => {
          switch (currentStepIndex) {
            ...
            case 2:
              return `Information${softwareName === undefined ? "" : ` about ${softwareName}`
                }`;
            case 3:
              return `Prerequisites${softwareName === undefined ? "" : ` of ${softwareName}`
                }`;
            case 4:
              return `Similar and equivalent software${softwareName === undefined ? "" : ` of ${softwareName}`
                }`;
            default:
              return "";
          }
      ...
      "SoftwareFormStep3": {
        "is software has health datas":
          "Does software process health data ?",
      ...
      "SoftwareCatalogCard": {
        ...
        "isSoftwareHasHealthDataD": "software has health datas",
      ...
      "SoftwareCatalogSearch": {
        ...
        "isSoftwareHasHealthData": "Comes with possible support",
      ...
      "HeaderDetailCard": {
        ...
        "software dereferenced": ({
          ...
          reason,
          when
        }) => `From ${when}, this software is no longer recommended${reason === undefined ? "" : `, ${reason}`
        }}.
    ...
    "fr": {
      ...
      "SoftwareForm": {
        "stepper title": ({ currentStepIndex, softwareName, action }) => {
          switch (currentStepIndex) {
            ...
            case 2:
              return `Information${softwareName === undefined
                ? ""
                : ` à propos de ${softwareName}`
                }`;
            case 3:
              return `Pré-requis${softwareName === undefined ? "" : ` pour ${softwareName}`
                }`;
            case 4:
              return `Logiciels similaires ou équivalents${softwareName === undefined ? "" : ` à ${softwareName}`
                }`;
            default:
              return "";
          }
      ...
      "SoftwareFormStep3": {
        "is software has health datas":
          "Le logiciel traite des données de santé ?",
        "is from french public service":
      ...
      "SoftwareCatalogCard": {
        ...
        "isSoftwareHasHealthDataD":
          "Ce logiciel traite des données de santé",
      ...
      "SoftwareCatalogSearch": {
        ...
        "isSoftwareHasHealthData": "Le logiciel traite des données de santé",
      ...
      "SoftwareDetails": {
        ...
        "isSoftwareHasHealthDataD": "Ce logiciel traite des données de santé",
      ...
      "HeaderDetailCard": {
        ...
        "software dereferenced": ({
          ...
          reason,
          when
        }) => `Depuis ${when}, ce logiciel n'est plus recommandé ${reason === undefined ? "" : ` : « ${reason} »`
        }.
                ${!lastRecommendedVersion
            ? ""
